...
export default class MarketWfrp4e {
    ...
    static generateSettlementChoice(rarity) {
        ...
        renderTemplate("systems/taa/templates/chat/market/market-settlement.html", cardData).then(html => {
    ...
    static generatePayCard(payRequest, player) {
        ...
        } else //generate a card with a summary and a pay button
        {
            ...
            renderTemplate("systems/taa/templates/chat/market/market-pay.html", cardData).then(html => {
    ...
    static generateCreditCard(creditRequest, option = "EACH") {
        ...
        } else //generate a card with a summary and a receive button
        {
            ...
            renderTemplate("systems/taa/templates/chat/market/market-credit.html", cardData).then(html => {
